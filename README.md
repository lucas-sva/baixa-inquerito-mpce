...
Números extraídos dos relatórios públicos de produtividade de promotores (Corregedoria do MPCE), de julho de 2025 a junho de 2026. Códigos do sistema SAJ:
...
O site é estático (HTML, CSS e JavaScript sem dependências). Após o push, o Pages publica a raiz de `main`.
